package com.only.seata.order.config;
...
*/
@Configuration
@MapperScan(basePackages = {"com.only.seata.order.mapper"})
public class MyBatisConfig {
    ...
    public SqlSessionFactoryBean sqlSessionFactory(DataSourceProxy dataSourceProxy) throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.only.seata.order.entity");
