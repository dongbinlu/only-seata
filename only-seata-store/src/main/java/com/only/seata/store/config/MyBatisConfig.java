package com.only.seata.store.config;
...
*/
@Configuration
@MapperScan(basePackages = {"com.only.seata.store.mapper"})
public class MyBatisConfig {
    ...
    public SqlSessionFactoryBean sqlSessionFactory(DataSourceProxy dataSourceProxy) throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.only.seata.store.entity");
